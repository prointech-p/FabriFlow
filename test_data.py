...
from app.models import Status, StageType, MachineModel, Workshop  # Замените 'app' на имя вашего приложения, где находятся модели
...
from app.models import Machine, MachineModel, Workshop, Status  # замени 'app' на имя твоего приложения
...
from datetime import datetime
from app.models import Detail, Status  # замени 'app' на имя твоего приложения
...
from app.models import Stage, Detail, StageType, Machine  # замени 'app' на имя приложения
...
from datetime import datetime
from app.models import MachineAssignment, Machine, Detail  # замени 'app' на имя твоего приложения
...
from datetime import datetime
from app.models import MachineAssignment, Machine, Detail  # замени 'app' на своё приложение
